#ifndef UTM_CONVERSION_UTILS_H
#define UTM_CONVERSION_UTILS_H
 ...
 * Meridian convergence（子午线收敛角即坐标纵线偏角） is computed as for Spherical Transverse Mercator,
